...
--
-- Host: localhost    Database: MovieWorld
-- ------------------------------------------------------
...
CREATE TABLE `like_dislike` (
  ...
  `target_type` enum('movie') NOT NULL,
  ...
  CONSTRAINT `like_dislike_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
--
-- Dumping routines for database 'MovieWorld'
--
...
-- Dump completed on 2024-11-09  0:40:13
